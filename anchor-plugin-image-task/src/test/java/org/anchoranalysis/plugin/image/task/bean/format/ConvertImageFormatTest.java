...
class ConvertImageFormatTest {
    ...
    private void performTest(ChannelSpecification channelSpecification, String resourceDirectorySuffix, String[] filenamesToCompare) throws OperationFailedException {
