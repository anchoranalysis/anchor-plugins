...
public class NamedChannels implements Iterable<Entry<String,Channel>> {
	...
	/**
	 * Creates by combining multiple existing existing {@link NamedChannel}s.
	 * 
	 * @param source the {@link NamedChannel}s to combine.
	 ...
	 * @throws OperationFailedException if a channel with the same name, has already been previously added.
	 */
