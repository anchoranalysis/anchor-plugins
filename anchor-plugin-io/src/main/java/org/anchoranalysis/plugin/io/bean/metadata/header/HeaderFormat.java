 ...
 * 
 * <p>The <a href="https://github.com/drewnoakes/metadata-extractor">metadata-extractor</a> from Drew Noakes is used to read the metadata.
 * 
 * @author Owen Feehan
 *
 */
public abstract class HeaderFormat extends AnchorBean<HeaderFormat> {
     ...
     */
    protected abstract Optional<ImageMetadata> populateFromMetadata(Metadata metadata) throws ImageIOException;
}