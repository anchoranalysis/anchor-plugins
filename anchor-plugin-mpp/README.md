...
Plugins related to marked-point-processes (particularly proposers and providers).
...
* the [developer guide](https://www.anchoranalysis.org/developer_guide.html), especially [anchor-plugins](https://www.anchoranalysis.org/developer_guide_repositories_anchor_plugins.html) for an overview of all modules in this repository.
