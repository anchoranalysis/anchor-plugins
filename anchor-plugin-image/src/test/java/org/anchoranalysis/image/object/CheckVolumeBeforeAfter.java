...
public class CheckVolumeBeforeAfter {
    ...
    /** Allows % tolerance in the number of voxels in the area of a voxelized circle relative to the mathematical expected value */
    private static final double RATIO_TOLERANCE_FOR_VOXELIZATION = 0.05;
    
    public static void assertCircularArea( String objectIdentifier, int expectedRadius, ObjectMask object ) {
    ...
    public static void assertDiscreteVolume( String objectIdentifier, int expectedNumberVoxels, ObjectMask object) {
        assertVolumeEquals(objectIdentifier, expectedNumberVoxels, object, 0);
    }
    
    private static void assertVolumeEquals( String message, double expectedNumberVoxels, ObjectMask object, double tolerance ) {
