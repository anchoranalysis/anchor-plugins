...
public class ObjectCollectionTest {
    ...
    /** Tests scaling up on many objects (deliberately chosen to exceed the 255 objects possible with an unsigned byte type) */
    @Test
    ...
    /** 
     * Scales up an object-collection with an interpolator and checks that the total
     * area of the objects is as expected after scaling
     * 
     ...
     */
    private void testNumberCircles(int numberCircles, double radiusIncrease) throws OperationFailedException {
        ...
        ObjectCollection unscaled = CircleObjectFixture.successiveCircles(numberCircles, new Point2d(10,10), 3, new Point2d(10,8), radiusIncrease);
