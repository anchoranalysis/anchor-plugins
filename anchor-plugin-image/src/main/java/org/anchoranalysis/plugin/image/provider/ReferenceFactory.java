 ...
 * <p>
 * This is particularly useful to avoid to referring to multiple identically named {@code Reference} classes
 * in the same file, necessitating the use of the fully qualified class name.
 * 
 * @author Owen Feehan
 *
 */
...
public class ReferenceFactory {
    ...
    public static org.anchoranalysis.plugin.image.bean.channel.provider.Reference channel(String id) {
        return new org.anchoranalysis.plugin.image.bean.channel.provider.Reference(id);
    }
    
    public static org.anchoranalysis.plugin.image.bean.object.provider.Reference objects(String id) {
    ...
    public static org.anchoranalysis.plugin.image.bean.histogram.provider.Reference histogram(String id) {
