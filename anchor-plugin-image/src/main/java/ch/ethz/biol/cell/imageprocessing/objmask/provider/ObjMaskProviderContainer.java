...
public abstract class ObjMaskProviderContainer extends ObjMaskProviderOne {
	...
	protected Optional<ObjectMaskCollection> containerOptional() throws CreateException {
	...
	protected ObjectMaskCollection containerRequired() throws CreateException {
