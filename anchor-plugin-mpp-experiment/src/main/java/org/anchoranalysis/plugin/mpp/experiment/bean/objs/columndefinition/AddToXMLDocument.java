...
/**
 * Adds particular types of child-elements to an XML-document
 * 
 * @author Owen Feehan
 *
 */
...
class AddToXMLDocument {
	...
	public void addObjectMask(String suffix, String[] array, ObjectInCsvRowIndices indices) {
		...
		addPoint(
			...
			ArrayExtracter.getAsPoint(array,indices.getPoint())
		);
	}
	
	/** Adds a child-element to the {@code topLevelParent} representing a Point encoded as three integer elements in an array */
	...
	/**
	 * Adds a child-element to the {@code topLevelParent} representing a particular integer element from an array
	 * 
